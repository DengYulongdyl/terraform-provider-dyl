...
copy:
	tar -xvf bin/terraform-provider-dyl_darwin_amd64.tgz && mv bin/terraform-provider-dyl $(shell dirname `which terraform`)

clean:
	rm -rf bin/*

mac:
	GOOS=darwin GOARCH=amd64 go build -o bin/terraform-provider-dyl
	zip -r bin/terraform-provider-dyl_darwin_amd64.zip bin/terraform-provider-dyl
...
windows:
	GOOS=windows GOARCH=amd64 go build -o bin/terraform-provider-dyl.exe
	zip -r  bin/terraform-provider-dyl_windows_amd64.zip bin/terraform-provider-dyl.exe
...
linux:
	GOOS=linux GOARCH=amd64 go build -o bin/terraform-provider-dyl
	zip -r czvf bin/terraform-provider-dyl_linux_amd64.zip bin/terraform-provider-dyl
	rm -rf bin/terraform-provider-dyl
...
freebsd-with-version:
	GOOS=freebsd GOARCH=amd64 go build -o terraform-provider-dyl_v$(RELEASE_TAG)
	zip -r terraform-provider-dyl_$(RELEASE_TAG)_freebsd_amd64.zip terraform-provider-dyl_v$(RELEASE_TAG)
	rm -rf terraform-provider-dyl_v$(RELEASE_TAG)

	GOOS=freebsd GOARCH='386' go build -o terraform-provider-dyl_v$(RELEASE_TAG)
	zip -r terraform-provider-dyl_$(RELEASE_TAG)_freebsd_386.zip terraform-provider-dyl_v$(RELEASE_TAG)
	rm -rf terraform-provider-dyl_v$(RELEASE_TAG)

	GOOS=freebsd GOARCH=arm go build -o terraform-provider-dyl_v$(RELEASE_TAG)
	zip -r terraform-provider-dyl_$(RELEASE_TAG)_freebsd_arm.zip terraform-provider-dyl_v$(RELEASE_TAG)
	rm -rf terraform-provider-dyl_v$(RELEASE_TAG)

	GOOS=freebsd GOARCH=arm64 go build -o terraform-provider-dyl_v$(RELEASE_TAG)
	zip -r terraform-provider-dyl_$(RELEASE_TAG)_freebsd_arm64.zip terraform-provider-dyl_v$(RELEASE_TAG)
	rm -rf terraform-provider-dyl_v$(RELEASE_TAG)
...
checksum:
	...
	shasum -a 256 *.zip > terraform-provider-dyl_$(RELEASE_TAG)_SHA256SUMS
